...
public class Minion extends Card {
    ...
    public void drawInHand(FXGraphics2D g2d, ResizableCanvas canvas, Point2D position){
        Rectangle2D cardBase = new Rectangle2D.Double(position.getX(),
                position.getY(),
        ...
        Ellipse2D costEllipse = new Ellipse2D.Double(cardBase.getX(),
                cardBase.getY(),
        ...
        Ellipse2D attackEllipse = new Ellipse2D.Double(cardBase.getX(),
        ...
        Ellipse2D healthEllipse = new Ellipse2D.Double(cardBase.getX() + cardBase.getWidth()*0.7,
                cardBase.getY() + cardBase.getWidth()*0.7*(cardBase.getHeight()/cardBase.getWidth()),
                cardBase.getWidth()*0.3,
                cardBase.getWidth()*0.3);
        ...
        g2d.drawString(this.cardName, (int)(cardNameBox.getCenterX()-cardNameBox.getWidth()*this.cardName.length()*0.2), (int)(cardNameBox.getCenterY()*1.1));
    }

    public void drawOnBoard(FXGraphics2D g2d){
